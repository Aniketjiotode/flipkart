            ...
            <header>
                <div class="search">
                    <svg xmlns="http://www.w3.org/2000/svg" width="101" height="28">
                        <defs>
                            <radialGradient id="b" cx="-6.347%" cy="56.143%" r="421.128%" fx="-6.347%" fy="56.143%"
                                gradientTransform="matrix(0 -.18076 1 0 -.625 .55)">
                                <stop offset="0%" stop-color="#F6A520" />
                                <stop offset="100%" stop-color="#FFF" />
                            </radialGradient>
                            <radialGradient id="c" cx="46.434%" cy="91.634%" r="448.213%" fx="46.434%" fy="91.634%"
                                gradientTransform="matrix(-.17045 0 0 -1 .543 1.833)">
                                <stop offset="0%" stop-color="#F6A520" />
                                <stop offset="100%" stop-color="#FFF" />
                            </radialGradient>
                            <radialGradient id="d" cx="106.443%" cy="56.143%" r="423.105%" fx="106.443%" fy="56.143%"
                                gradientTransform="matrix(0 -.17991 1 0 .503 .753)">
                                <stop offset="0%" stop-color="#F6A520" />
                                <stop offset="100%" stop-color="#FFF" />
                            </radialGradient>
                            <linearGradient id="a" x1="50.003%" x2="50.003%" y1="99.984%" y2="-.024%">
                                <stop offset="1%" stop-color="#FFCB00" />
                                <stop offset="40%" stop-color="#F7E830" />
                                <stop offset="100%" stop-color="#F7E830" />
                            </linearGradient>
                            <linearGradient id="e" x1="50.972%" x2="50.972%" y1="6.806%" y2="106.528%">
                                <stop offset="0%" stop-color="#F7E830" />
                                <stop offset="100%" stop-color="#F6A520" />
                            </linearGradient>
                            <linearGradient id="f" x1="49.412%" x2="49.412%" y1="4.621%" y2="106.76%">
                                <stop offset="0%" stop-color="#F7E830" />
                                <stop offset="100%" stop-color="#F6A520" />
                            </linearGradient>
                        </defs>
                    ...
                    <a href="#">
                        <form action="">
                            ...
                            <div class="searchpanel">
                                ...
                                <input type="text" placeholder="Search for products,brands and more" checked/>

                                    {/* <button class="btn"  type="submit"><img src="https://i.ibb.co/Lx8GXV8/searchicon.png" alt="searchicon" border="0"/></button> */}
                    ...
                    <a href="#">
                        <div class="tag1"> Become a seller</div>
                    </a>
                    <a href="#">
                        <div class="tag2"> More</div>
                    </a>
                     <Link to='/placeorder'>
                        <div class="tag3"> cart <img src="https://i.ibb.co/SNLbv3x/cart.png" alt="cart" border="0"/><span style={{fontSize:'19px'}}>({cart.totalItems})</span></div>
                    </Link>
                    {/* <div style={{margintop:"18px",marginleft:"30px"}}> <button class="but" onClick={changemode}>
                        <i class="bi bi-moon-fill"></i>
                    </button></div>

                    <span id="weather" class=""></span> <button id="degree" onClick={geolocation}>⛅</button>  */}
